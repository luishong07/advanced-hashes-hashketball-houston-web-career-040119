...
# hash1 = {:home => {:team_name => "Broollyn Nets"
#                     :colors => ["Black","White"]
...
# #how access value based on input and not call it myself

# def num_points_scored(name) 
# # hash1.each do |home_key1,home_value1|
# player = find_the _player(name)
# player.fetch(:points)
...
#from this point below its the answer, testing, why different syntax???
def game_hash
  {
    home: {
...
def num_points_scored(name)
  player = find_the_player(name) #why find_the_? what is it exactly?
  player.fetch(:points)
end
